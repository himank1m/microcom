...
export const metadata: Metadata = {
  ...
  description:
    "Contact Microware Communications for IT solutions, CCTV installation, computers, custom software, custom websites, enterprise networking, server solutions, and IT AMC services.",
  alternates: {
    canonical: "/contact"
  }
};
