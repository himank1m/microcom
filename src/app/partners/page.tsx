...
export const metadata: Metadata = {
  ...
  description:
    "Microware Communications works with technology brands including HP, Dell, Lenovo, Microsoft, Cisco, Hikvision, CP Plus, Epson, Canon, Logitech, TP-Link, and Matrix.",
  alternates: {
    canonical: "/partners"
  }
};
